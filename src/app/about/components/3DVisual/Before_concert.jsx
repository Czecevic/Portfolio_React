...
Command: npx gltfjsx@6.2.16 .\public\models\before_concert.glb 
...
export function Before_concert(props) {
  const { nodes, materials } = useGLTF("./models/before_concert.glb");
  return (
...
useGLTF.preload("./models/before_concert.glb");
